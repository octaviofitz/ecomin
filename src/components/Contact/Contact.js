    ...
    return (
        ...
        <section className='contacto' id='contacto'>
          <div>
            ...
            <p className='texto'>Completá el formulario y a la brevedad nos contactaremos con usted</p>
            <p className='texto'>También pueden contactarnos a nuestro teléfono: 11 41 436490 o a través de nuestras redes sociales: </p>
            </div>
        <div>
